...
async function run() {
  try {
    ...
    const upazilasCollection = client
      .db("bldm")
      .collection("upazilas");
    const usersCollection = client.db("bldm").collection("users");
    const donationRequestCollection = client
      .db("bldm")
      .collection("donationRequests");
    const blogsCollection = client.db("bldm").collection("blogs");
    const fundingCollection = client.db("bldm").collection("funding");
...
app.get("/", (req, res) => {
  res.send("BLDM SERVER IS RUNNING");
});
